...
- **License audit**: incremental analysis and R# API support.
...
- **Automatic generation of new inspections** using rule introspection.
- **Linter updates**:
    - Rider SafeCode EAP
...
- **Qodana Cloud API** for configuring teams, projects, memberships, SSO and others.
- **%premlite% documentation** covering deployment and usage. 
