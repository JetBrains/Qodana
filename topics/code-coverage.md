...
1. Use your code coverage tool to generate coverage reports. 
Starting from version 2026.2, %product% detects code coverage reports in a project root directory as described in the table below:

    | Linters                       | Directories and files supported                                                                 |
    |-------------------------------|-------------------------------------------------------------------------------------------------|
    | [%jvm%](jvm.md) <br/> %jvm-a% | Default Jacoco and Kover paths supported for Maven and Gradle                                   |
    | [%js%](js.md)                 | Directories: `reports` and `test-coverage` <br/> File: `coverage/lcov.info`                     |
    | [%php%](php.md)               | Directories: `build/logs`, `reports`, `coverage` <br/> Files: `clover.xml` and `coverage.xml`   |
    | [%python%](python.md)         | Directories: `coverage-reports`, `reports` <br/> File: `coverage.xml`                           |
...
<link-summary>Learn how to configure code coverage for the %dotnet% linter.</link-summary>
...
<link-summary>Fresh code is the code contained in a GitHub pull request. %instance% can calculate fresh code coverage and display the results.</link-summary>
...
<link-summary>After you've run code coverage, you can view reports in %cloud% and using IDEs.</link-summary>
...
<link-summary>After you've run code coverage, you can view reports in %cloud%.</link-summary>
...
<link-summary>After you've run code coverage, you can view reports using your IDE.</link-summary>
...
<link-summary>Explore how you can open reports using %cloud%.</link-summary>
...
<link-summary>You can view code coverage reports based on your local machine.</link-summary>

You can view code coverage reports based locally.

In your IDE, navigate to the <ui-path>Coverage</ui-path> tool window.
...
<link-summary>The IDE highlights the codebase test coverage using color marking. Learn more about reports containing code coverage data.</link-summary>
...
<link-summary>Open an analysis report for a pull or merge request, and the IDE will show you code coverage for the code fragments
contained in the pull or merge request.</link-summary>

If you open an analysis report for a pull or merge request, the IDE will show you code coverage for the code fragments
contained in the pull or merge request. 

For example, lines 10 to 15 are not highlighted because they are not part of a pull or merge request. 

<img src="code-coverage-report-coverage-incremental-analysis.png" width="706" alt="The incremental analysis code coverage" border-effect="line" thumbnail="true"/>

If your IDE is connected with a remote repository, in the **Coverage** tool window you can use 
the **Filters | Show Only Modified Files** button to see the classes containing incremental changes along with their code coverage.

<img src="code-coverage-coverage-window-changes.png" width="706" alt="The Coverage tool window" border-effect="line" thumbnail="true"/>
