...
<table>
    ...
    <tr>
        ...
        <td><a href="https://www.nuget.org/packages/coverlet.msbuild">Coverlet</a></td>
...
<tabs>
    <tab title="Qodana for JVM" title="code-coverage-github-jvm"><code style="block" lang="yaml"></code></tab>
    <tab title="Qodana for JS" title="code-coverage-github-js">
...
runs-on: ubuntu-latest
    ...
    <tab title="Qodana for PHP" title="code-coverage-github-php">
        <code style="block" lang="yaml">
...
runs-on: ubuntu-latest
    ...
    <tab title="Qodana for Python" title="code-coverage-github-python">
        <code style="block" lang="yaml">
...
runs-on: ubuntu-latest
    ...
    <tab title="Qodana for Go" title="code-coverage-github-go">
        <code style="block" lang="yaml">
