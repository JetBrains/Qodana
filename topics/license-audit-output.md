...
- To override the detection results, add the recommended settings to  
[`qodana.yaml`](qodana-yaml.md#License+audit+configuration) and save the configuration file to the root of the analyzed project.
