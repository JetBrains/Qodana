...
| `results-dir`                                  | Directory to store the analysis reports relative to the project root. Optional.                                                                                                              | `$CI_PROJECT_DIR/.qodana/results` |
...
| `use-caches`                                   | Utilize [GitHub caches](https://docs.gitlab.com/ci/caching/) for Qodana analyses. Optional.                                                                                                  | `true`                            |
