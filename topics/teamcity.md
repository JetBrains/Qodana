...
- If you run your own TeamCity agents using Docker images of %product%, make sure that Docker is installed on the agent machines and accessible to the users TeamCity is running under.
...
<link-summary>%product% uses a project token generated by %cloud%.</link-summary>

%product% uses a <a href="project-token.md">project token</a> generated by %cloud%. This token is required for the 
paid %instance% <a href="pricing.md" anchor="pricing-linters-licenses">linters</a> and optional for use with the 
...
<link-summary>Using the 'Additional Qodana arguments' field of the runner configuration, you can configure the quality gate and baseline features.</link-summary>
...
<link-summary>Using the runner configuration, you can configure pull and merge requests.</link-summary>
...
<step>
<p>On the build page, navigate to the <ui-path>Qodana</ui-path> tab to find the analysis report. To learn more about Qodana 
