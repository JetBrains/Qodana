...
<var name="docker-image" value="jetbrains/qodana-&lt;python|community&gt;:2025.3"/>
...
You can install project dependencies using the [`bootstrap`](qodana-yaml.md#Run+custom+commands) key, for example:
