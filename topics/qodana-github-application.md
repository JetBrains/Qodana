...
While the Qodana GitHub app supports only public repositories, for private repositories use the [Qodana Code Inspection GitHub action](qodana-github-action.md).
