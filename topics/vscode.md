...
<procedure>
    <step>
        <p>In Visual Studio Code, navigate to the <a anchor="vs-code-ui-overview"><ui-path>%product%</ui-path></a> view, click <ui-path>Run Locally</ui-path>.</p>
...
<procedure>
   ...
   <step>
      <p>
         In the <ui-path>%product%</ui-path> view, select a project in Qodana Cloud that you would like to link with 
          your local project, and then click <ui-path>Link</ui-path>.
      </p>
