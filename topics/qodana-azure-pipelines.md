...
<var name="microsoft-git-commands" value="https://learn.microsoft.com/en-us/azure/devops/pipelines/scripts/git-commands?view=azure-devops&tabs=classic#allow-scripts-to-access-the-system-token"/>
   ...
   <tab title="Pipeline configuration" group-key="azure-config-tabs-azure-pipelines-yaml">
      <code-block lang="yaml" emphasize-lines="13,14,21,23">
        ...
        <tab title="Classic interface" group-key="azure-config-tabs-classic-editor">
            ...
            <p>To have access to the system token during pull request analyses, follow the 
                instructions from the <a href="%microsoft-git-commands%">Microsoft website</a>.</p>
        </tab>
</tabs>

### Using input arguments

<link-summary>Use input arguments to extend the configuration.</link-summary>
...
<link-summary>Learn how you can enable analyses for pull requests.</link-summary>
...
<link-summary>Learn how to enable the baseline and quality gate features for your projects.</link-summary>
...
<link-summary>Learn how to enable Quick-Fixes for your projects.</link-summary>
