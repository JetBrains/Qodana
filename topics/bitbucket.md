...
section explains how you can run %instance% [Docker images](deploy-qodana.md#deploy-qodana-container-mode) in Bitbucket Cloud 
  ...
  branches:
    main:
      - step:
          ...
          caches:
            - qodana
          image: jetbrains/qodana-<image> # Specify a Qodana image here. For example, jetbrains/qodana-jvm:latest
          script:
