...
<var name="docker-image" value="jetbrains/qodana-python-community:2024.3-eap"/>
...
In case the project has external `pip` dependencies, you can set them up using the `bootstrap` key in the `qodana.yaml` file.  
