...
project directory. This file is usually generated by your build system. After reading the `compile_commands.json` file, 
%product% analyzes the project, generates analysis reports and saves them locally or uploads to Qodana Cloud.
