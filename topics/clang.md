...
<link-summary>Details of the %qdcppc% linter implementation.</link-summary>
...
<link-summary>Steps related to linter configuration prior to running %product%.</link-summary>
...
<procedure>
    <step>
        ...
        <note>
            ...
            %product% profile, edit the profile using the <code>exclude</code> field in the <a href="configuration-reference.md" anchor="exclude-paths"><code>qodana.yaml</code> file </a>.</p>
    ...
    <step>
        ...
        <p>
          If you use CMake, you can also generate a compilation database by specifying the following <a href="configuration-reference.md" anchor="Run+custom+commands"><code>bootstrap</code></a> option in the <code>qodana.yaml</code> file, for example:
        </p>
...
<link-summary>Prepare your software before running %product%.</link-summary>

<include from="lib_qd.topic" element-id="before-start-prepare-software" use-filter="empty,generic"/>

## Run Qodana

<link-summary>Learn how to run %product% to analyze your C/C++ projects.</link-summary>
...
<link-summary>Learn how you can study analysis reports generated by %product%.</link-summary>
...
<link-summary>Learn various techniques that let you extend the basic configuration of %product%.</link-summary>

### Adjusting the scope of analysis

<link-summary>Adjust the scope of analysis to better fit your needs.</link-summary>
...
<list>
    <li>Commands that will run before the linter using the <a href="configuration-reference.md" anchor="Run+custom+commands"><code>boostrap</code></a>
...
<note>The %qdcppc% linter does not support including 
and <a href="configuration-reference.md" anchor="exclude-paths">excluding</a> paths for specific inspections using the <code>qodana.yaml</code> file.</note>

### Modifying paths for analysis

<link-summary>Adjust the paths used by %product% for analysis.</link-summary>
...
To run a script, use the `bootstrap` section of the [`qodana.yaml`](configuration-reference.md) file, for example:
...
<link-summary>Enable the baseline feature to better manage your technical debt.</link-summary>
...
Save this snippet to the [`qodana.yaml`](configuration-reference.md) file:
...
<link-summary>Learn how to analyze pull requests using the %cpp% linter.</link-summary>
...
[`qodana.yaml`](configuration-reference.md) file save the following configuration that uses the `cpp` and `cmakePreset` sections:
...
<link-summary>List of features supported by the %cpp% and %clang% linters.</link-summary>
...
<link-summary>Disclaimer about using statistics gained our software.</link-summary>
