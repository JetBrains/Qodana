...
<var name="ssh-gitlab" value="https://docs.gitlab.com/ee/user/project/deploy_keys/#create-a-project-deploy-key"/>
<var name="ssh-github" value="https://docs.github.com/en/authentication/connecting-to-github-with-ssh/managing-deploy-keys#set-up-deploy-keys"/>
<var name="ssh-space" value="https://www.jetbrains.com/help/space/git-keys-and-passwords.html#ssh-key"/>
...
<p>Copy this public key and save it in your VCS on the project level. For example, you can read how to do it in 
<a href="%ssh-gitlab%">GitLab</a>, <a href="%ssh-github%">GitHub</a> and <a href="%ssh-space%">JetBrains Space</a>. 
In case of GitHub and JetBrains Space, start from step 2, i.e. skip the SSH key generation step.</p> 
