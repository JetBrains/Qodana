...
* [Vulnerability checker](vulnerability-checker.md) to monitor your project for presence of vulnerabilities from 
third-party software

Besides that, now %product% provides the new [](qodana-python-community.md) linter. 

Finally, the existing linters were updated with new inspections.  
...
| `IncorrectProcessCanceledExceptionHandling`       | ProcessCanceledException' handled incorrectly                                                         | `ERROR`        | Disabled     |
