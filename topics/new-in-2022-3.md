...
This page provides the list features that were implemented in the version 2022.3 of %product%.
...
Except Qodana Community for JVM, a bunch of CSS inspections were added to all %product% linters.
