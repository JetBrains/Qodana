...
<link-summary>%product% produces output files contained in several directories.</link-summary>

## Output structure

<link-summary>Each Qodana analysis produces the following output located in the output directory.</link-summary>

Each Qodana code analysis run produces the following output located in the output directory:

- **log/**: contains  `idea.log`, `gradle.log`, and so on.
- **projectStructure/**: project information: modules, frameworks/libraries, roots, and so on.
...
- **qodana.sarif.json**: report in the [SARIF](qodana-inspection-output.md#SARIF+Output) format.

## SARIF Output

<link-summary>%product% reports are formatted according to the SARIF specification and are contained in a JSON file.</link-summary>
...
<link-summary>Learn a structure of a SARIF report generated by %product%.</link-summary>
...
<link-summary>The tool object describes the %product% linter, bundled plugins, and the available inspections.</link-summary>
...
<link-summary>The driver object contains information about the invoked %product% linter.</link-summary>
...
<link-summary>Each element of the extensions object provides information about the plugin name and version, as well as the inspections provided by the plugin.</link-summary>
...
<link-summary>The invocations array tells whether %product% ran successfully or not. </link-summary>
...
<link-summary>The versionControlProvenance array describes the version control systems that the project code was checked out from.</link-summary>
...
<link-summary>The results array describes the problems found during analyses.</link-summary>

The `results` array describes the problems found during analyses.
...
| `partialFingerprints` | Contains hashes for comparing reports between different analyses. Used by the [baseline](baseline.topic) feature                                                                                                                                                                                                                                                                                                                                 |
...
<link-summary>The location object describes a concrete physical location in a file, augmented by a high-level logical location.</link-summary>
...
<link-summary>The physicalLocation object describes a location of a file.</link-summary>
...
<link-summary>The region object describes the line and column of a code fragment within a file.</link-summary>
...
<link-summary>The logicalLocations object describes the module name obtained from the project build system.</link-summary>
...
<link-summary>The automationDetails object provides the details of the run object.</link-summary>

The [`automationDetails`](https://docs.oasis-open.org/sarif/sarif/v2.1.0/os/sarif-v2.1.0-os.html#_Toc34317523) object
...
<link-summary>The newlineSequences array specifies a character sequence that %product% treated as a line break.</link-summary>

The [`newlineSequences`](https://docs.oasis-open.org/sarif/sarif/v2.1.0/os/sarif-v2.1.0-os.html#_Toc34317510) array
contains unique strings, each of which specifies a character sequence that %instance% treated as a line break during analyses.
...
<link-summary>The properties object contains information about inspections for unexpected problems related to a project configuration.</link-summary>
...
<link-summary>The list of severity levels available in SARIF-formatted files.</link-summary>
