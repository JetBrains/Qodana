...
In this section you can find the list of new inspections as of 2024.1, as well as the inspections that were removed or disabled.
To learn how to enable the disabled inspections, you can visit the [](qodana-yaml.md#Include+an+inspection+into+the+analysis+scope)
section.
