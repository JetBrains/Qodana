...
* [Docker images](deploy-qodana.md#deploy-qodana-container-mode) of %product%
* The [Qodana Scan](github.md) GitHub action

## Prepare your project

<link-summary>Prepare your project before analyzing your monorepo project.</link-summary>
...
<link-summary>To configure %product% for analyzing two projects, you need to create two YAML-formatted files, one for each linter.</link-summary>

To configure %product% for analyzing two projects, you need to create two YAML-formatted [configuration files](configuration-reference.md), 
...
<link-summary>In %cloud%, create a separate project for each part of your monorepo.</link-summary>
...
<link-summary>Explore how to run %product% on your monorepo project.</link-summary>
...
<link-summary>Use %cloud% to view analysis reports generated by %product%.</link-summary>
