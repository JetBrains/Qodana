...
| `CppClangTidyClangDiagnosticCoroNonAlignedAllocationFunction`      | coro-non-aligned-allocation-function clang diagnostic                                                                                                                                      | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticCpp23DefaultCompRelaxedConstexpr`      | c++23-default-comp-relaxed-constexpr clang diagnostic                                                                                                                                      | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticCpp23Extensions`                       | c++23-extensions clang diagnostic                                                                                                                                                          | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticCpp26Extensions`                       | c++26-extensions clang diagnostic                                                                                                                                                          | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticCpp2cExtensions`                       | c++2c-extensions clang diagnostic                                                                                                                                                          | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticDeprecatedLiteralOperator`             | deprecated-literal-operator clang diagnostic                                                                                                                                               | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticDeprecatedRedundantConstexprStaticDef` | deprecated-redundant-constexpr-static-def clang diagnostic                                                                                                                                 | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticDxilValidation`                        | dxil-validation clang diagnostic                                                                                                                                                           | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticEagerLoadCxxNamedModules`              | eager-load-cxx-named-modules clang diagnostic                                                                                                                                              | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticGenericTypeExtension`                  | generic-type-extension clang diagnostic                                                                                                                                                    | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticHipOmpTargetDirectives`                | hip-omp-target-directives clang diagnostic                                                                                                                                                 | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticInvalidStaticAssertMessage`            | invalid-static-assert-message clang diagnostic                                                                                                                                             | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticInvalidUnevaluatedString`              | invalid-unevaluated-string clang diagnostic                                                                                                                                                | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticMicrosoftInitFromPredefined`           | microsoft-init-from-predefined clang diagnostic                                                                                                                                            | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticMissingMultilib`                       | missing-multilib clang diagnostic                                                                                                                                                          | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticMultiGpu`                              | multi-gpu clang diagnostic                                                                                                                                                                 | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticReservedModuleIdentifier`              | reserved-module-identifier clang diagnostic                                                                                                                                                | `WARNING`      | Enabled      |
| `CppClangTidyClangDiagnosticSyncAlignment`                         | sync-alignment clang diagnostic                                                                                                                                                            | `WARNING`      | Enabled      |
| `CppClangTidyBugproneEmptyCatch`                                   | bugprone-empty-catch clang-tidy check                                                                                                                                                      | `WARNING`      | Enabled      |
| `CppClangTidyBugproneMultipleNewInOneExpression`                   | bugprone-multiple-new-in-one-expression clang-tidy check                                                                                                                                   | `WARNING`      | Enabled      |
| `CppClangTidyBugproneNonZeroEnumToBoolConversion`                  | bugprone-non-zero-enum-to-bool-conversion clang-tidy check                                                                                                                                 | `WARNING`      | Enabled      |
| `CppClangTidyBugproneUniquePtrArrayMismatch`                       | bugprone-unique-ptr-array-mismatch clang-tidy check                                                                                                                                        | `WARNING`      | Enabled      |
| `CppClangTidyBugproneUnsafeFunctions`                              | bugprone-unsafe-functions clang-tidy check                                                                                                                                                 | `WARNING`      | Enabled      |
| `CppClangTidyCppcoreguidelinesAvoidCapturingLambdaCoroutines`      | cppcoreguidelines-avoid-capturing-lambda-coroutines clang-tidy check                                                                                                                       | `WARNING`      | Enabled      |
| `CppClangTidyCppcoreguidelinesMisleadingCaptureDefaultByValue`     | cppcoreguidelines-misleading-capture-default-by-value clang-tidy check                                                                                                                     | `WARNING`      | Enabled      |
| `CppClangTidyCppcoreguidelinesMissingStdForward`                   | cppcoreguidelines-missing-std-forward clang-tidy check                                                                                                                                     | `WARNING`      | Enabled      |
| `CppClangTidyCppcoreguidelinesNoexceptDestructor`                  | cppcoreguidelines-noexcept-destructor clang-tidy check                                                                                                                                     | `WARNING`      | Enabled      |
| `CppClangTidyCppcoreguidelinesNoexceptMoveOperations`              | cppcoreguidelines-noexcept-move-operations clang-tidy check                                                                                                                                | `WARNING`      | Enabled      |
| `CppClangTidyCppcoreguidelinesNoexceptSwap`                        | cppcoreguidelines-noexcept-swap clang-tidy check                                                                                                                                           | `WARNING`      | Enabled      |
| `CppClangTidyCppcoreguidelinesRvalueReferenceParamNotMoved`        | cppcoreguidelines-rvalue-reference-param-not-moved clang-tidy check                                                                                                                        | `WARNING`      | Enabled      |
| `CppClangTidyMiscHeaderIncludeCycle`                               | misc-header-include-cycle clang-tidy check                                                                                                                                                 | `WARNING`      | Enabled      |
| `CppClangTidyModernizeTypeTraits`                                  | modernize-type-traits clang-tidy check                                                                                                                                                     | `WEAK WARNING` | Enabled      |
| `CppClangTidyModernizeUseStdPrint`                                 | modernize-use-std-print clang-tidy check                                                                                                                                                   | `WEAK WARNING` | Enabled      |
| `CppClangTidyPerformanceAvoidEndl`                                 | performance-avoid-endl clang-tidy check                                                                                                                                                    | `WARNING`      | Enabled      |
| `CppClangTidyPerformanceNoexceptDestructor`                        | performance-noexcept-destructor clang-tidy check                                                                                                                                           | `WARNING`      | Enabled      |
| `CppClangTidyPerformanceNoexceptSwap`                              | performance-noexcept-swap clang-tidy check                                                                                                                                                 | `WARNING`      | Enabled      |
| `CppClangTidyReadabilityAvoidUnconditionalPreprocessorIf`          | readability-avoid-unconditional-preprocessor-if clang-tidy check                                                                                                                           | `WARNING`      | Enabled      |
| `CppClangTidyReadabilityOperatorsRepresentation`                   | readability-operators-representation clang-tidy check                                                                                                                                      | `WEAK WARNING` | Enabled      |
...
| `CppClangTidyClangDiagnosticDeprecatedExperimentalCoroutine`  | deprecated-experimental-coroutine clang diagnostic    | `WARNING` | Enabled      |
| `CppClangTidyClangDiagnosticExportUsingDirective`             | export-using-directive clang diagnostic               | `WARNING` | Enabled      |
| `JSConstructorReturnsPrimitive`                               | Constructor returns primitive value                   | `WARNING` | Disabled     |
