...
It also shows the number of projects covered and not covered with tests, and lets you navigate to the respective projects.
...
Shows the number of problems detected in your projects on a specific date. Using this diagram, you can see the progress
in code quality.
