...
[TeamCity](teamcity.md). With other CI/CD systems, you can use [Docker images](deploy-qodana.md#Docker+images). 
...
create your own inspection profile in YAML and XML [formats](inspection-profiles.md).
